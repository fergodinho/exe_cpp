...
do{
   ...
   cout<<"\n [1] Opção sem IF e FOR";
   cout<<"\n [2] Desenho com o FOR";
   cout<<"\n [3] Verificação de dado com 'IF'";
        ...
        case 2:{
      	...
      	case 8:{
				...
				cout << fixed << setprecision(1);// deixar o float com 2 casas decimais
				 ...
				 cout<<"\n\n> Use o programa para obter a MAIOR e MENOR temperatura em ºC de uma semana";
				 ...
				 cout<<"\n> Média de temperaturas da semana   "<<acum_temperaturas/TAM<<"ºC";				
				 cout<<"\n\n\n";
